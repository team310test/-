...
void Audio::gameInit()
{
    ...
    // BGM
    music::load(GAME_AUDIO::BGM_GAME, L"./Data/Musics/BGM/BGM_Game.wav", 1.0f);
    ...
    music::load(GAME_AUDIO::SE_DEATH,   L"./Data/Musics/SE/SE_Death.wav",    1.0f);
    music::load(GAME_AUDIO::SE_COMBINE, L"./Data/Musics/SE/SE_Combine2.wav", 1.0f);
    music::load(GAME_AUDIO::SE_SHRINK,  L"./Data/Musics/SE/SE_Shrink.wav",   1.0f);
}