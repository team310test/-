...
GameLib::LoadTexture gameLoadTexture[] = {
    ...
    { GAME_TEXNO::BG03, L"./Data/Images/BackGround/BackGround06.png",  1U }, // 2前面(縮小後は後面)
    { GAME_TEXNO::BG04, L"./Data/Images/BackGround/BackGround01.png",  1U }, // 3中間
    { GAME_TEXNO::BG05, L"./Data/Images/BackGround/BackGround03.png",  1U }, // 3前面(縮小後は後面)
    { GAME_TEXNO::BG06, L"./Data/Images/BackGround/BackGround06.png",  1U }, // 4中間
    { GAME_TEXNO::BG07, L"./Data/Images/BackGround/BackGround10.png", 1U }, // 4前面(縮小後は後面)
    { GAME_TEXNO::BG08, L"./Data/Images/BackGround/BackGround03.png",  1U }, // 5中間
    { GAME_TEXNO::BG09, L"./Data/Images/BackGround/BackGround08.png",  1U }, // 5前面(縮小後は後面)
    { GAME_TEXNO::BG10, L"./Data/Images/BackGround/BackGround10.png", 1U }, // 6中間
    { GAME_TEXNO::BG11, L"./Data/Images/BackGround/BackGround05.png",  1U }, // 6前面(縮小後は後面)
