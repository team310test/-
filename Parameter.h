...
namespace
{
    ...
    namespace
    {
        ...
        #define PL_PARTS_ATK_TIME   (60)        // 攻撃クールタイム
...
namespace
{
    ...
    namespace
    {
        ...
        #define DROP_COMMON01_NEXT_HP   (2) // プレイヤーになるときの体力                                          
        #define DROP_COMMON02_NEXT_HP   (2) // プレイヤーになるときの体力
        #define DROP_COMMON03_NEXT_HP   (2) // プレイヤーになるときの体力
        #define DROP_COMMON04_NEXT_HP   (2) // プレイヤーになるときの体力
        #define DROP_COMMON05_NEXT_HP   (2) // プレイヤーになるときの体力                                          
        #define DROP_COMMON06_NEXT_HP   (2) // プレイヤーになるときの体力
    }
