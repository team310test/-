...
#define DMG_TIME                    (30)                // ダメージを受けた時の点滅時間
...
#define PL_PARTS_ATK_TIME   (90)        // 攻撃クールタイム

        // パーツ各攻撃力(体当たりダメージ)
        namespace
        {
#define PL_TURRET01_ATK     (0)     // 攻撃力(体当たりダメージ)
#define PL_TURRET02_ATK     (0)     // 攻撃力(体当たりダメージ)
#define PL_TURRET03_ATK     (0)     // 攻撃力(体当たりダメージ)
...
#define ENM_TURRET03_ATK        (2)         // 攻撃力(体当たりダメージ)
    ...
    namespace
    {
#define ENM_BUFF01_HP           (6)         // 体力
#define ENM_BUFF01_ATK          (2)         // 攻撃力(体当たりダメージ)
    }

    // EnemyCommon
    namespace
    {
#define ENM_COMMON01_HP         (8)       // 体力
#define ENM_COMMON01_ATK        (2)       // 攻撃力(体当たりダメージ)

#define ENM_COMMON02_HP         (8)       // 体力
#define ENM_COMMON02_ATK        (2)       // 攻撃力(体当たりダメージ)

#define ENM_COMMON03_HP         (8)       // 体力
#define ENM_COMMON03_ATK        (2)       // 攻撃力(体当たりダメージ)

#define ENM_COMMON04_HP         (8)       // 体力
#define ENM_COMMON04_ATK        (2)       // 攻撃力(体当たりダメージ)

#define ENM_COMMON05_HP         (8)       // 体力
#define ENM_COMMON05_ATK        (2)       // 攻撃力(体当たりダメージ)

#define ENM_COMMON06_HP         (8)       // 体力
#define ENM_COMMON06_ATK        (2)       // 攻撃力(体当たりダメージ)
    }
...
namespace
{
#define DROP_PARTS_SPEED_X (-3.0f)       // X速度
...
#define DROP_COMMON03_NEXT_HP   (1) // プレイヤーになるときの体力
#define DROP_COMMON04_NEXT_HP   (1) // プレイヤーになるときの体力
#define DROP_COMMON05_NEXT_HP   (1) // プレイヤーになるときの体力                                          
#define DROP_COMMON06_NEXT_HP   (1) // プレイヤーになるときの体力
    }
...
#define PL_SHOT_AREA_MARGIN             (200.0f)// 画面外の有余
    // 通常弾
    namespace
    {
...
#define SQUARE_WAVE_SHOT_ATK        (1)
    ...
    namespace
    {
#define CURVE_SHOT_SPEED_X          (5.0f)
#define CURVE_SHOT_SPEED_Y          (-20.0f)
#define CURVE_SHOT_ACCEL_X          (0.5f)   // X速度に足すX加速度
#define CURVE_SHOT_ACCEL_Y          (0.75f)   // Y速度に足すY加速度
#define CURVE_SHOT_ATK              (1)
    ...
    namespace
    {
#define PENETRATE_SHOT_SPEED        (80.0f)
...
#define LETTER_BOX_ADD_SPEED    (0.0175f)   // 加算(黒帯が上がる速度)					 
//#define LETTER_BOX_SUB_SPEED    (-0.005f)  // 減算(黒帯が降りる速度)				   	 
#define LETTER_BOX_SUB_SPEED    (-0.0075f)  // 減算(黒帯が降りる速度)				   	 
    }
